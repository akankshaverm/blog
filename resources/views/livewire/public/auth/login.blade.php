<div class="flex flex-1 flex-col justify-center items-center h-[85vh] bg-slate-100">
    <div class="w-4/12 border p-5 rounded-lg shadow-lg bg-white">
        ...
        <div class=" p-5 rounded-lg ">
            <a href="{{url('auth/google')}}" class="flex items-center mb-4 justify-center w-full py-2 px-4 border bg-blue-300 font-semibold rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition ease-in-out duration-150">
